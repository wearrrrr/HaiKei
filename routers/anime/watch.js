...
try {
    ...
    if (loginState == true) {
        res.render('watch_zoro.ejs', {watchInfo: watchRes, loginState: loginState, username: username, showInfo: showInfo, epData: epData, epIds: infoRes.episodes, recommended: recommendedData, trending: trendingData})
    } else {
        res.render('watch_zoro.ejs', {watchInfo: watchRes, loginState: loginState, showInfo: showInfo, epData: epData, epIds: infoRes.episodes, recommended: recommendedData, trending: trendingData})
    }
...
async function getWatchDataGogo(req, res) {
  ...
  try {
    ...
    if (loginState == true) {
       return res.render('watch.ejs', {data: results, epData: epData, downloadUrl: downloadUrl, showInfo: showInfo, trending: trendingData, recommended: recommendedData, username: username, loginState: loginState}); 
    }
    return res.render('watch.ejs', {data: results, epData: epData, downloadUrl: downloadUrl, showInfo: showInfo, trending: trendingData, recommended: recommendedData, loginState: loginState});
  } catch (error) {
    console.error(error);
